...
const TripItem = props => {
  ...
  let itemsBought = ["Gas", " Brisket", " Dessert", " Home Goods", " Outdoor", " Jerky", " Cold Grab n' Go", " Hot Grab n' Go", " 3rd-Party"];
  let itemsBool = [false, false, false, false, false, false, false, false, false];

  if (props.didGas === true)
    itemsBool[0] = true;
  if (props.didBrisket === true)
    itemsBool[1] = true;
  if (props.didDessert === true)
    itemsBool[2] = true;
  if (props.didHomeGood === true)
    itemsBool[3] = true;
  if (props.didOutdoor === true)
    itemsBool[4] = true;
  if (props.didJerky === true)
    itemsBool[5] = true;
  if (props.didColdGrab === true)
    itemsBool[6] = true;
  if (props.didHotGrab === true)
    itemsBool[7] = true;
  if (props.did3rdParty === true)
    itemsBool[8] = true;
        ...
        <li className="trip-item">
          <Card className="trip-item__content">
            <div className="trip-item__info">
              <h2>{props.date}: {props.location}</h2>
